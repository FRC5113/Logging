...
public class WidgetsAndLayouts {
    ...
    public static ShuffleboardLayout TalonFXLayout (String name, ShuffleboardTab tab, SmartFalcon motor){
    ...
    public static ShuffleboardLayout TalonFXLayout (String name, ShuffleboardTab tab, TalonFX motor){
        return TalonFXLayout(name, tab, (SmartFalcon) motor);
    }

    // Solenoid Widget
    public static SuppliedValueWidget<Boolean> SolenoidWidget (String name, ShuffleboardTab tab, SmartSolenoid sol){
        return tab.addBoolean(name, sol::get);
    }

    public static SuppliedValueWidget<Boolean> SolenoidWidget (String name, ShuffleboardLayout layout, SmartSolenoid sol){
