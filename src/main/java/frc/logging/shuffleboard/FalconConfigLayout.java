...
// for examples of use, see: https://github.com/Spectrum3847/Infrared-2022/blob/main/src/main/java/frc/lib/telemetry/FalconConfigLayout.java
public class FalconConfigLayout extends CustomLayout{
    private final SmartFalcon talon;
    ...
    public FalconConfigLayout(String name, ShuffleboardTab tab, SmartFalcon talon, int column, int row) {
        super(name, tab);
        this.talon = talon;
